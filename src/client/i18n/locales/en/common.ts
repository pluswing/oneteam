export const en = {
  ...
  setup: {
    title: "Drop a folder to get started",
    description: "The dropped Git repository becomes the folder OneTeam works on.",
    dropZoneLabel: "Drop a folder here",
    dropFolder: "Drop a folder here",
    orChooseFolder: "or click to choose a folder",
    desktopDropHint: "Folder drag and drop is available in the desktop app.",
    importing: "Preparing the folder…",
    browserFallback: "Using the browser development server?",
    pathPlaceholder: "/path/to/repository",
    openFolder: "Open folder",
    defaultsNote: "Codex and the automatic issue → implementation → pull request → merge workflow use the defaults.",
    dropError: "No folder was found in the drop.",
    folderOnly: "Drop a folder, not a file.",
    browserDropUnsupported: "The browser cannot read an absolute folder path. Use the desktop app or enter the path below.",
    openFailed: "The folder could not be opened.",
    repository: "Repository",
    mode: "Mode",
    importMode: "Import",
    createMode: "Create",
  ...
  issues: {
    ...
    closed: "Closed",
    noIssues: "No issues",
    triageInbox: "Triage notifications",
    triageDescription: "Review work discovered by automation before it enters the implementation loop.",
    triageConvert: "Convert to issue",
    triageConverting: "Converting…",
    triageIgnore: "Ignore",
    triageActionFailed: "Failed to update the Triage item.",
    comments: "comments",
    checks: "Checks",
    ...
    humanGateDescription: "Automation is waiting for a human decision or additional input.",
    openGate: "Open agent run",
    permalink: "Permalink",
    edited: "Edited",
    ...
    commentHistoryFailed: "Failed to load comment history.",
    showFullComment: "Show full report",
    collapseComment: "Collapse report",
    ...
    initialRequestTitle: "Tell OneTeam what you want to do",
    initialRequestDescription: "Write your request below. Sending the comment starts the automatic Codex workflow.",
    initialRequestPlaceholder: "Example: Simplify the settings screen and add tests for the new flow.",
  ...
  settings: {
    title: "Settings",
    managedDefaultsTitle: "Automatic defaults are active",
    managedDefaultsDescription: "OneTeam uses Codex and the default automatic merge policy. Advanced provider, Loop, model, budget, and merge settings are temporarily hidden.",
    server: "Server",
    database: "Database",
    locale: "Locale",
    provider: "AI provider",
    roleRouting: "Role routing",
    roleRoutingDescription: "Pin a provider and model when each Agent Job is queued. Leave a field inherited to use the project default.",
    inheritProvider: "Project default",
    inheritModel: "Provider default model",
  ...
  development: {
    ...
    codex_login_required: "Codex login required",
    loginHint: "Run codex login, then resume the Loop. The desktop app opens login when a task starts.",
    restore: "Restore this file to its previous version",
    mergeQueued: "Merge requested. The Loop will recheck and merge the verified changes.",
    "title": "Development Loops",
    "empty": "Create an Issue to start a development loop.",
    ...
    "waiting_capacity": "Waiting for Codex",
    "paused": "Paused",
    "failed": "Stopped",
    "canceled": "Canceled",
    "succeeded": "Completed",
    ...
    "cancel": "Cancel loop",
    "agentLog": "Agent log",
    "retrospectiveAndHistory": "Retrospective & history",
    "autoModel": "Automatic model",
    "awaitRetrospective": "The retrospective runs after merge. The loop completes once learning has been saved.",
    "before": "Before",
    "after": "After",
    "executions": "Model execution history",
