...
MVP 実装開始時は以下の issue を作成すると進めやすい。

1. Scaffold TypeScript React + API app
2. Add libSQL migrations and repository layer
3. Implement setup wizard
4. Implement command auto-detection
5. Implement issue CRUD
6. Implement pull request CRUD and diff viewer
7. Implement agent job queue and activity log
8. Implement Codex CLI adapter
9. Implement requirements agent
10. Implement implementation agent
11. Implement review/fix/QA agents
12. Add Playwright QA coverage
