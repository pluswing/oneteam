...
- [ ] **Partial**: 全画面共通のfocus-visible ringとreduced-motion、diffの`j` / `k` shortcut、file listのArrow / Home / End roving focus、ARIA current / pressed、keyboard E2Eは実装済み。画面別のkeyboard操作とcontrastの網羅監査は未完了
